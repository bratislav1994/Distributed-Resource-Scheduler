...
namespace KSResTest
{
    ...
    public class ControlerTest
    {
        ...
        [Test]
        [TestCase(50)]
        public void P_01(double requiredAP)
        {
        ...
        [Test]
        [TestCase(60)]
        public void P_02(double requiredAP)
        {
            List<Point> setPoints = new List<Point>();
        ...
        [Test]
        [TestCase(130)]
        public void P_03(double requiredAP)
        {
            List<Point> setPoints = new List<Point>();
        ...
        [Test]
        [TestCase(50)]
        public void P_04(double requiredAP)
        {
            List<Point> setPoints = new List<Point>();
        ...
        [Test]
        [TestCase(60)]
        public void P_05(double requiredAP)
        {
            List<Point> setPoints = new List<Point>();
        ...
        [Test]
        [TestCase(20)]
        public void P_06(double requiredAP)
        {
            List<Point> setPoints = new List<Point>();
        ...
        [Test]
        [TestCase(20)]
        public void P_07(double requiredAP)
        {
            List<Point> setPoints = new List<Point>();
